    ...
    <div class="relative min-h-screen px-4 py-2">
        ...
        <div class="flex-1">
            ...
            <div v-else class="grid grid-cols-2 gap-2">
                <div class="bg-orange-300 p-2 rounded-md transition-all ease-in-out duration-150 hover:shadow-md hover:scale-105"
                    ...
                    <div class="dropdown dropdown-end" @click.stop>
                        ...
                        <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-32">
                            ...
                            <li><a @click.prevent="roomStore.deleteRoom(room._id, route.params.id)">Delete</a></li>
                        </ul>
                    </div>
                </div>
                </div>
